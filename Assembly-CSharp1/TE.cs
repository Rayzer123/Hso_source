...
public class TE : T
{
	// Token: 0x0600098F RID: 2447 RVA: 0x0009D574 File Offset: 0x0009B774
	public TE()
	{
		...
		T.mTips = new string[]
		{
			"Hold chat button in 2s, it will open the quick chat menu.",
			"Lucky boxes are appear randomly every 1 hour in map.",
			"One guild can own more than one mine.",
			"Hunting monsters and challenges another knight will gain fame.",
			"Fame will decline if knight inactive for some time.",
			"Complete dungeon can earn Pet eggs.",
			"Register arena at Mr. Ballard in Fire Cave.",
			"Boss will reborn after 12 hour.",
			"Enhance item will randomly get bone.",
			"Ghost will appear after Knight reached level 20.",
			"Health point can be restored when standing still or using food.",
			"Can join Zone(2h) for free with Tyche coin.",
			"In Zone(2h), drop rates and experience will be higher other zone."
		};
		...
		T.story = new string[]
		{
			"Over 500 years ago, this great land served as a battleground between two great armies from two ancient kingdoms. At that time, everyone lived in fear as horrific monsters arose. The war eventually ended, but left great hardship as the struggling survivors tried to rebuild the peace.",
			"The Fellowship of Knights was created to protect the land and people. Stories of great bravery and heroism spread, and it soon became the dream of every young child to grow up and become a great knight.",
			"You are becoming a young adult, and it is time for you to accept this challenge and prove you are ready to join the Fellowship of Knights."
		};
		...
		T.mAuto = new string[]
		{
			"Use HP potion when HP is lower than ",
			"Use HP potion when MP is lower than"
		};
		T.mUtien = new string[]
		{
		...
		T.mValueAutoItem = new string[][]
		{
			...
			{
				"Loot all",
				"Loot from blue items",
				"Loot from yellow items",
				"Loot from purple items",
				"Loot from orange items",
				"Do not want to loot "
			},
			new string[]
			{
		...
		T.mHelp = new string[][]
		{
			new string[]
			{
				"Welcome to the world of the Knight Online.",
				"This is the instrucions for newbie. ",
				"Press key 2 to go up, key 8 to down, key 4 to left and  key 6 to right.",
				"You also can use arrows to move easier.",
				"Please move to the yellow position on the screen. "
			},
			new string[]
			{
			...
			new string[]
			{
				"This is inventory where you can put everything in it. ",
				"Currently, you have several healing potion, mana potion and 1 pair of shoes. ",
				"Try to use healing potion by moving white frame to healing potion. ",
				"Left click and use ",
				"Click and use",
				"Very good, there is another way for you to use healing and mana potion by set up short cut in order to action more quicker. ",
				"You can use HOT KEY to act faster.",
				"Move cursor to healing potion and choose it again.",
				"Use HOT KEY this time and choose one which key you are familiar with.",
				"Choose and click on HOT KEY.",
				"Click on Choose and select HOT KEY. ",
				"Do it the same for using keybiindings to mana potion. ",
				"Try to use HOT KEY when needed."
			},
			new string[]
			{
				"There are a pair of shoes in your inventory.",
				"Besides making you look pretty, they will also make you stronger.",
				"Equipping them will increase your health. ",
				"Try to equip them now.",
				"Click Choose and select Use. ",
				"So simple, right? ",
				"Whatever you equip, will appear in Inventory. ",
				"Select inventory to see what you have. ",
				"Move your cursor here."
			},
			new string[]
			{
				"Character information helps you know which clothes you are wearing.",
				"The left side shows character and your rate resistance to effect",
				"The right side shows attack power and defense.",
				"This is what you are wearing.",
				"When you want to equip an item in your inventory. ",
				"Choose the slot you want and change your item. ",
				"It is also a great way to compare the power of different items.",
				"Try this function when you find new loot.",
				"Now get back to your adventure.",
				"Right click to exit."
			},
			new string[]
			{
			...
			new string[]
			{
				"Level Up.There are many interesting things that you need to know.",
				"Click Inventory - Character.",
				" Left click and choose Inventory - Character."
			},
			new string[]
			{
				"Character screen tell you everything about you. ",
				"You will see 4 attributes:  strength, dexterity, vitality & intelligence ",
				"Every time you level up, you will earn 1 extra point.",
				"You will also get 5 points to add to your character as you like.",
				"Look at your character info to see the difference.",
				"Try to add points into health section to see the change.",
				"Move here and click Choose.",
				"Very good.  Now see how your index increased.",
				"When you level up, your skills will also increase.",
				"Move cursor to here to see."
			},
			new string[]
			{
