...
{
	// Token: 0x06000990 RID: 2448 RVA: 0x0009F434 File Offset: 0x0009D634
	public TIndo()
	{
		...
		T.mTips = new string[]
		{
			"Tahan tombol chatting di 2s, itu akan membuka obrolan cepat menu.",
			"Kotak beruntung yang muncul secara acak setiap 1 jam di peta.",
			"Satu serikat dapat memiliki lebih dari satu tambang.",
			"Berburu monster dan tantangan ksatria lain akan mendapatkan ketenaran.",
			"Ketenaran akan menurun jika ksatria aktif untuk beberapa waktu.",
			"Penjara Lengkap bisa mendapatkan telur Pet.",
			"Register arena di Mr Ballard dalam neraka Cave.",
			"Boss akan terlahir kembali setelah 12 jam.",
			"Meningkatkan barang secara acak akan mendapatkan tulang.",
			"Ghost akan muncul setelah Ksatria mencapai level 20.",
			"Titik Kesehatan dapat dikembalikan ketika berdiri diam atau menggunakan makanan.",
			"Bisa bergabung Zone (2h) secara gratis dengan Tyche koin.",
			"Di Zona (2h), drop tarif dan pengalaman akan zona lainnya yang lebih tinggi."
		};
		T.mQuickChat = new string[]
		{
			...
			"Ayo",
			"Mari kita menyerang saya!",
			"Mari berburu bos!",
			"Yang membunuh saya!",
			"Terlalu ramai!",
			"Apakah Anda ingin PK?",
			"Harap mengundang saya untuk serikat!",
			"Merekrut anggota!",
			"Pergi tidur",
			"Bye!",
			"berbahaya! menjalankan",
			"Tolong aku!"
		};
		...
		T.story = new string[]
		{
			...
			"negara besar ini menjadi area pertempuran dari 2 pasukan kerajaan kuno. + Pada saat itu",
			"Semua orang hidup dalam ketakutan ketika monster mengerikan muncul. + Peperangan pun akhirnya selesai",
			"Tapi meninggalkan kesusahan karena orang orang yang masih bertahan berusaha membangun kedamaian",
			"The Fellowship of Knights diciptakan untuk melindungi negara dan rakyat. + Cerita tentang keberanian dan kepahlawanan pun menyebar",
			"dan kemudian menjadi impian dari semua anak-anak muda untuk tumbuh besar dan menjadi ksatria yang hebat.",
			"Kamu menjadi dewasa",
			"dan sekarang waktunya kamu menerima tantangan ini dan membuktikan kamu siap bergabung dengan The Fellowship of Knights"
		};
		...
		T.mAuto = new string[]
		{
			"Gunakan potion HP jika HP lebih rendah dari",
			"Gunakan potion MP jika MP lebih rendah dari"
		};
		T.mUtien = new string[]
		{
			"Prioritas: < kecil ke besar >",
			"Prioritas: < kecil ke besar >"
		};
		...
		T.mValueAutoItem = new string[][]
		{
			...
			{
				"Ambil semua",
				"Ambil dari item biru",
				"Ambil dari item kuning",
				"Loot dari item ungu",
				"Loot dari item Orange",
				"Tidak mau Ambil "
			},
			new string[]
			{
		...
		T.mHelp = new string[][]
		{
			new string[]
			{
				"Selamat datang di dunia Ksatria Online.",
				"Ini adalah instruksi untuk pemula. ",
				"Tekan 2 untuk ke atas, 8 untuk ke bawah, 4 ke kiri dan 6 ke kanan.",
				"Bisa juga menggunakan tombol panah.",
				"Harap bergerak ke posisi warna kuning di layar. "
			},
			new string[]
			{
			...
			new string[]
			{
				"Ini adalah inventory, kamu bisa menaruh segalanya di sini. ",
				"Sekarang kamu punya beberapa healing potion, mana potion dan 1 shoes. ",
				"Coba gunakan healing potion dengan menggerakkan kotak putih ke healing potion. ",
				"Klik kiri dan gunakan ",
				"Klik dan gunakan",
				"Bagus sekali, ada cara lain untuk menggunakan healing potion dan mana potion dengan membuat short cut agar lebih cepat. ",
				"Kamu bisa menggunakan HOT KEY untuk bertindak lebih cepat.",
				"Gerakkan cursor ke healing potion dan pilih kembali.",
				"Gunakan HOT KEY kali ini dan pilih tombol yang kamu sukai.",
				"Pilih dan klik HOT KEY.",
				"Klik Pilih dan pilih HOT KEY. ",
				"Lakukan yang serupa untuk mana potion.",
				"Coba gunakan HOT KEY jika diperlukan."
			},
			new string[]
			{
				"Ada shoes baru di inventory kamu.",
				"Selain mempercantik dirimu, itu juga membuatmu lebih kuat.",
				"Mengequip shoes akan menaikkan health kamu.",
				"Coba equip sekarang",
				"Klik Pilih dan pilih Use. ",
				"Mudah kan? ",
				"Apapun yang kamu equip akan muncul di inventory. ",
				"Pilih inventory untuk melihat apa yang kamu miliki. ",
				"Gerakkan cursormu kemari."
			},
			new string[]
			{
				"Informasi karakter memberitahu pakaian apa yang kamu pakai.",
				"Sisi kiri menunjukkan karakter dan ketahananmu terhadap efek.",
				"Sisi kanan menunjukkan attack power dan defense.",
				"Ini adalah apa yang kamu pakai.",
				"Kalau kamu mau mengequip item di inventory. ",
				"Pilih slot yang kamu inginkan dan ganti itemmu. ",
				"Ini juga cara yang bagus untuk membandingkan kekuatan item-item yang berbeda.",
				"Cobalah ini saat kamu mendapatkan loot baru.",
				"Ayo, kembali bertualang.",
				"Klik kanan untuk keluar."
			},
			new string[]
			{
				string.Empty,
			...
			new string[]
			{
				"Level Naik.Banyak hal menarik yang harus kamu tahu.",
				"Klik Inventory - Karakter.",
				" Klik kiri dan pilih Inventory - Character."
			},
			new string[]
			{
				"Layar karakter akan memberitahu segala sesuatu tentang dirimu. ",
				"Kamu akan melihat 4 attribute: strength, dexterity, vitality & intelligence ",
				"Setiap kamu naik level, kamu akan mendapatkan 1 point tambahan.",
				"Kamu juga akan mendapat 5 point untuk ditambahkan ke karaktermu.",
				"Lihat ke karakter untuk melihat perbedaan.",
				"Coba tambah point ke health untuk melihat perubahan.",
				"Bergerak kemari dan klik Pilih.",
				"Bagus sekali. Lihat bagaimana status kamu bertambah.",
				"Saat kamu naik level, skill kamu juga bertambah.",
				"Gerakkan cursor kemari untuk melihat."
			},
			new string[]
			{
